...
<p align="center">
  ...
  <br><br>
  <b>
    <a href="http://www.levingaeher.com/WebGL_NodeEditor/">WebGL Demo</a> - 
    <a href="http://forum.unity3d.com/threads/simple-node-editor.189230/#post-2134738">Forum Thread</a> -
    <a href="http://www.levingaeher.com/Node_Editor_Framework/">Documentation</a>
  </b>
</p>
...
4. A small example of extending the editor controls can be seen in the included [Node Group](https://github.com/Seneral/Node_Editor/blob/develop/Node_Editor_Framework/Framework/Core/NodeGroup.cs). It contains custom controls to handle without modifying any framework code.
